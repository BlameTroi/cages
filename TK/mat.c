...
## 
## SYNOPSIS
##   Mat [-L|-S] Group SetList1 SetList2
##   Mat [-L|-S] Group SetList1 SetList2 BOUND
## 
## DESCRIPTION
...
setbuf(stderr,0);
 ...
 BOUNDFLAG=0;
 if(ac-SW==5) {BOUND=atoi(av[SW+4]); BOUNDFLAG=1;}
 fscanf(f,"%d",&deg); 
 U=NewUniverse(deg);
